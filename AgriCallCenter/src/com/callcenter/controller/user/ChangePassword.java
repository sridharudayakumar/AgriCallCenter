...
public class ChangePassword extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(role.equals("Administrator"))
			{
				request.setAttribute("fileName", "include/adminmenu.jsp");
			}
			else if(role.equals("Agri Officer"))
			{
				request.setAttribute("fileName", "include/agriofficermenu.jsp");
			}
			else if(role.equals("Tele Caller"))
			{
				request.setAttribute("fileName", "include/telecallermenu.jsp");
			}
