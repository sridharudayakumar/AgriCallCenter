...
<body>
	<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion"
		...
		<li class="nav-item active"><a class="nav-link" href="admin.jsp">
				<i class="fas fa-fw fa-tachometer-alt"></i> <span>Admin Home</span>
		</a></li>
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			aria-expanded="true" aria-controls="collapseTwo"> <i
				class="fas fa-user-plus"></i> <span>User</span>
		</a>
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
				data-parent="#accordionSidebar">
				<div class="bg-white py-2 collapse-inner rounded">
					<h6 class="collapse-header">User Control:</h6>
					<a class="collapse-item" href="RegisterUser.jsp">Register User</a> <a
						class="collapse-item" href="ShowUsers">Show Users</a>
