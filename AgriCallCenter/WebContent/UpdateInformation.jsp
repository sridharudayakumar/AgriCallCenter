...
<title>Call Center - Update Information</title>
...
<body id="page-top">
				...
				<div class="row">
					...
					<div class="col-lg-12 mb-4">
						<form class="needs-validation" method="post"
							...
							<input type="text" class="form-control" id="infoId" name="infoId"
								placeholder="" value='<c:out value="${id}"></c:out>'
								hidden="true">
							<div class="row">
								...
								<div class="col-md-6 mb-3">
									<label for="role">Category</label> <select
										...
										<option value="${information.category}" selected="selected"><c:out
												value="${information.category}"></c:out>
								...
								<div class="col-md-6 mb-3">
									<label for="category">Title</label> <input type="text"
										...
										value='<c:out value="${information.title}"></c:out>'
										required="">
  ...
  <c:out value="${information.description}"></c:out>
  </textarea>
